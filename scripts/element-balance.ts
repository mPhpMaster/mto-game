 ...
 *
 * **ما يقيسه بالضبط — وحدوده:** لكل لاعب ديكه الخاص (خمسون كارتاً بوصفةٍ
 * واحدة للاعبَين)، وليست فيه «مجموعة عنصر» تُواجه أخرى: الوصفة تأخذ من
 * العناصر كلّها. ما يُضبط هنا هو **الافتتاح** وحده: يفتح كل طرف بخمسة كروت
 * من عنصره (أرخص ثلاثة وحوش أساسية + فخّ + سحر، بالوصفة نفسها لكل عنصر)،
 * ثم يسحب كلٌّ من ديكه المختلط. فالقياس قياسُ الأدوار الأولى — وهي التي
 * تعمل فيها كلمات العنصر — لا قياسُ مباراة كاملة من عنصرٍ واحد.
 *
 * وانتبه: `opening` تأخذ **أرخص** سحرٍ في العنصر، وأرخص سحر الكهرباء
 * «اندفاع طاقة» بتكلفة صفر و+3 طاقة — فكل افتتاحٍ كهربائي هنا يحمل دَفعةَ
 * طاقةٍ مجانية تُغذّي «الشحنة الزائدة». وهذا من العنصر لا من الأداة، لكنه
 * يجعل الكهرباء تظهر هنا في أحسن صورها.
 *
