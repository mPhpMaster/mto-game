...
export const UI = {
  ...
  helpStuck: { ar: 'سحبٌ إضافي', en: 'Extra draw' },
  helpStuckBody: {
    ar: 'تستطيع سحب كارت إضافي مرة واحدة في كل دور بزر «اسحب كارتاً»، حتى لو كان في يدك ما يُلعب. السحب لا يُنهي دورك، فإن جاءك كارتٌ مطابق فالعبه فوراً.',
    en: 'You can draw one extra card each turn with “Draw a card”, even if you already hold something playable. Drawing does not end your turn — if the new card matches, play it right away.',
  },
  ...
  nameRequired: { ar: 'أدخل اسمك للدخول أونلاين', en: 'Enter your name to play online' },
  nameTooShort: { ar: 'الاسم قصير جداً (حرفان على الأقل)', en: 'Name is too short (at least 2 characters)' },
  nameTooLong: { ar: 'الاسم طويل جداً', en: 'Name is too long' },
  namePromptTitle: { ar: 'اسمك في اللعب أونلاين', en: 'Your online name' },
  namePromptBody: {
    ar: 'يظهر اسمك للاعبين الآخرين في الغرفة. يُحفظ على هذا الجهاز للمرة القادمة.',
    en: 'Your name is shown to other players in the room. It is saved on this device for next time.',
  },
  continueOnline: { ar: 'متابعة', en: 'Continue' },
  copyLink: { ar: '📋 انسخ الرابط', en: '📋 Copy link' },
  shareRoom: { ar: '📤 شارك الغرفة', en: '📤 Share room' },
  inviteShareTitle: { ar: 'انضمّ لمباراتي — مواجهة الوحوش', en: 'Join my match — Monster Clash' },
  inviteShareText: {
    ar: 'انضمّ لغرفتي! الرمز: {code}\n{url}',
    en: 'Join my room! Code: {code}\n{url}',
  },
  scanQr: { ar: '📷 التقاط رمز الاستجابة السريع', en: '📷 Scan QR code' },
  qrInvalid: {
    ar: 'لم يُعرف رابط الغرفة — تأكد من رمز الاستجابة السريع أو الصق الرابط.',
    en: 'Could not read a room link — check the QR code or paste the invite URL.',
  },
  qrCameraUnavailable: {
    ar: 'الكاميرا غير متاحة. الصق رابط الدعوة أدناه.',
    en: 'Camera unavailable. Paste the invite link below.',
  },
  qrPasteHint: {
    ar: 'أو الصق رابط الدعوة / رمز الغرفة:',
    en: 'Or paste the invite link / room code:',
  },
  qrPastePlaceholder: { ar: 'https://… أو ABC12', en: 'https://… or ABC12' },
  // --- الحساب والدخول ---
  signIn: { ar: 'تسجيل الدخول', en: 'Sign in' },
  signUp: { ar: 'حساب جديد', en: 'Create account' },
  signOut: { ar: 'خروج', en: 'Sign out' },
  username: { ar: 'اسم المستخدم', en: 'Username' },
  usernamePlaceholder: { ar: 'اسمك في اللعبة', en: 'Your in-game name' },
  password: { ar: 'كلمة المرور', en: 'Password' },
  passwordHint: { ar: '8 أحرف على الأقل', en: 'At least 8 characters' },
  usernameRequired: { ar: 'أدخل اسم مستخدم', en: 'Enter a username' },
  usernameTooShort: { ar: 'اسم المستخدم قصير (3 أحرف على الأقل)', en: 'Username is too short (at least 3 characters)' },
  usernameTooLong: { ar: 'اسم المستخدم طويل (20 حرفاً على الأكثر)', en: 'Username is too long (20 characters max)' },
  usernameCharset: {
    ar: 'يُسمح بالحروف والأرقام والشرطة السفلية والنقطة فقط',
    en: 'Only letters, digits, underscore and dot are allowed',
  },
  usernameTaken: { ar: 'اسم المستخدم مأخوذ — جرّب غيره', en: 'That username is taken — try another' },
  passwordTooShort: { ar: 'كلمة المرور قصيرة (8 أحرف على الأقل)', en: 'Password is too short (at least 8 characters)' },
  passwordTooLong: { ar: 'كلمة المرور طويلة جداً', en: 'Password is too long' },
  wrongCredentials: { ar: 'اسم المستخدم أو كلمة المرور غير صحيحة', en: 'Wrong username or password' },
  authUnavailable: { ar: 'خدمة الحسابات غير مهيّأة على هذا الخادم.', en: 'Accounts are not configured on this server.' },
  authFailed: { ar: 'تعذّر إتمام العملية — أعد المحاولة.', en: 'Could not complete that — please try again.' },
  registerNoRecovery: {
    ar: '⚠️ لا يوجد بريد إلكتروني، فلا يمكن استعادة كلمة المرور إن نسيتها. احفظها في مكان آمن.',
    en: '⚠️ There is no email, so a forgotten password cannot be recovered. Keep it somewhere safe.',
  },
  haveAccount: { ar: 'لديك حساب؟ سجّل الدخول', en: 'Have an account? Sign in' },
  noAccount: { ar: 'لا حساب لك؟ أنشئ واحداً', en: 'No account? Create one' },
  accountNeededOnline: { ar: 'اللعب الجماعي يحتاج حساباً', en: 'Online play needs an account' },
  accountNeededOnlineBody: {
    ar: 'الحساب يحفظ سجلّك وأصدقاءك ومستواك. أما اللعب ضد الخصم الآلي والتعليم واللعب على جهاز واحد فتعمل كلها بلا حساب ودون إنترنت.',
    en: 'An account keeps your history, friends and level. Playing the AI, the tutorial and one-device play all work with no account and no internet.',
  },
  continueAsGuestSolo: { ar: '🤝 العب على جهاز واحد بدل ذلك', en: '🤝 Play on one device instead' },
  accountTitle: { ar: 'حسابي', en: 'My account' },
  memberSince: { ar: 'عضو منذ {date}', en: 'Member since {date}' },
  levelLabel: { ar: 'المستوى {n}', en: 'Level {n}' },
  levelProgress: { ar: '{into} من {need} انتصاراً للمستوى التالي', en: '{into} of {need} wins to the next level' },
  winRatio: { ar: 'الفوز/الخسارة', en: 'Win / loss' },
  matchesPlayed: { ar: 'المباريات', en: 'Matches' },
  winRatePct: { ar: 'نسبة الفوز {pct}%', en: 'Win rate {pct}%' },
  topCardsTitle: { ar: 'أكثر الكروت لعباً', en: 'Most played cards' },
  topCardsNote: {
    ar: 'الوحوش والسحر والحركة فقط — هوية الفخّ المقلوب لا تُسجَّل حتى لا يقرأها الخصم.',
    en: 'Monsters, spells and actions only — a face-down trap’s identity is never logged, so opponents cannot read it.',
  },
  topElementsTitle: { ar: 'أكثر العناصر لعباً', en: 'Most played elements' },
  titanSummonsLabel: { ar: 'استدعاءات الوحش الأعظم', en: 'Titan summons' },
  trapsSetLabel: { ar: 'فخاخ جُهِّزت', en: 'Traps set' },
  myHistory: { ar: 'سجلّي', en: 'My history' },
  globalHistory: { ar: 'السجل العام', en: 'Global history' },
  noMatchesYet: { ar: 'لا مباريات بعد — العب واحدة!', en: 'No matches yet — go play one!' },
  openAccount: { ar: 'حسابي', en: 'My account' },
  openFriends: { ar: 'الأصدقاء', en: 'Friends' },

  // --- الأصدقاء والمراسلة ---
  friendsPageTitle: { ar: '👥 الأصدقاء', en: '👥 Friends' },
  tabFriends: { ar: 'الأصدقاء', en: 'Friends' },
  tabRequests: { ar: 'الطلبات', en: 'Requests' },
  tabMessages: { ar: 'الرسائل', en: 'Messages' },
  addByUsername: { ar: 'أضف صديقاً باسم المستخدم', en: 'Add a friend by username' },
  friendNotFound: { ar: 'لا حساب بهذا الاسم', en: 'No account with that username' },
  requestSent: { ar: '✓ أُرسل الطلب', en: '✓ Request sent' },
  alreadyFriends: { ar: 'أنتما صديقان بالفعل', en: 'You are already friends' },
  requestsIncoming: { ar: 'طلبات واردة', en: 'Incoming requests' },
  requestsOutgoing: { ar: 'طلبات مُرسَلة', en: 'Sent requests' },
  acceptRequest: { ar: 'اقبل', en: 'Accept' },
  declineRequest: { ar: 'ارفض', en: 'Decline' },
  cancelRequest: { ar: 'ألغِ', en: 'Cancel' },
  noRequests: { ar: 'لا طلبات.', en: 'No requests.' },
  noFriendsYet: { ar: 'لا أصدقاء بعد — أضف واحداً باسم مستخدمه.', en: 'No friends yet — add one by username.' },
  friendRequestToast: { ar: '{name} أرسل لك طلب صداقة', en: '{name} sent you a friend request' },
  friendAcceptedToast: { ar: '{name} قبِل طلب صداقتك', en: '{name} accepted your friend request' },
  playWithFriend: { ar: 'العب معه', en: 'Play' },
  messageFriend: { ar: 'راسله', en: 'Message' },
  inviteToThisLobby: { ar: 'ادعُ إلى هذا اللوبي', en: 'Invite to this lobby' },
  inviteToNewLobby: { ar: 'ادعُ إلى لوبي جديد', en: 'Invite to a new lobby' },
  inviteNoSeat: { ar: 'لا مقعد شاغر', en: 'No free seat' },
  inviteStarted: { ar: 'المباراة بدأت', en: 'The match has started' },
  inviteSentToast: { ar: 'أُرسلت الدعوة إلى {name}', en: 'Invite sent to {name}' },
  inviteReceivedToast: { ar: '{name} يدعوك للّعب', en: '{name} is inviting you to play' },
  inviteSeats: { ar: 'مقعد {taken} من {total}', en: 'Seat {taken} of {total}' },
  inviteExpired: { ar: 'انتهت صلاحية الدعوة', en: 'The invite has expired' },
  joinInvite: { ar: 'انضمّ', en: 'Join' },
  dismissInvite: { ar: 'لاحقاً', en: 'Later' },
  dmPlaceholder: { ar: 'اكتب رسالة…', en: 'Write a message…' },
  dmEmpty: { ar: 'لا رسائل بعد.', en: 'No messages yet.' },
  dmSend: { ar: 'أرسل', en: 'Send' },
  unreadCount: { ar: '{n} غير مقروءة', en: '{n} unread' },
  backToFriends: { ar: '⟶ الأصدقاء', en: '⟶ Friends' },
  importLocalFriends: { ar: 'استورد أصدقاءك المحفوظين', en: 'Import your saved friends' },
  importLocalFriendsBody: {
    ar: 'الأسماء المحفوظة على هذا الجهاز أسماء عرض لا حسابات، فابحث عن كلٍّ منها لتعرف إن كان صاحبها مسجَّلاً.',
    en: 'Names saved on this device are display names, not accounts. Search each one to see whether its owner has registered.',
  },
  searchThisName: { ar: 'ابحث', en: 'Search' },
  dismissImport: { ar: 'أخفِ', en: 'Dismiss' },

  friendsTitle: { ar: '👥 الأصدقاء', en: '👥 Friends' },
  friendsHint: {
    ar: 'احفظ أسماء أصدقائك محلياً وادعُهم بضغطة من الغرفة.',
    en: 'Save friend names locally and invite them from the room with one tap.',
  },
  friendsEmpty: { ar: 'لا أصدقاء محفوظون بعد.', en: 'No saved friends yet.' },
  addFriend: { ar: 'أضف', en: 'Add' },
  friendNamePlaceholder: { ar: 'اسم الصديق', en: "Friend's name" },
  inviteFriend: { ar: 'ادعُ', en: 'Invite' },
  invited: { ar: '✓ دُعي', en: '✓ Invited' },
  removeFriend: { ar: 'احذف', en: 'Remove' },
  inviteFriendMessage: {
    ar: 'يا {name}، انضمّ لمباراتي! الرمز: {code}\n{url}',
    en: 'Hey {name}, join my match! Code: {code}\n{url}',
  },
  ...
  flowLabel: { ar: 'التدفق', en: 'FLOW' },
  monsterDetails: { ar: 'تفاصيل الوحش', en: 'Monster details' },
  monsterDetailsEmpty: { ar: 'اضغط أي وحش على الساحة لترى قدراته', en: 'Tap any monster on the board to see its abilities' },
  boardStatus: { ar: 'حالة الساحة', en: 'Board status' },
  statMonsters: { ar: 'عدد الوحوش', en: 'Monsters' },
  statTraps: { ar: 'الفخاخ النشطة', en: 'Active traps' },
  statReady: { ar: 'الجاهزة للهجوم', en: 'Ready to attack' },
  statSpent: { ar: 'غير الجاهزة', en: 'Not ready' },
  elementsTitle: { ar: 'عناصر اللعبة', en: 'Elements' },
  quickGuideTitle: { ar: 'دليل سريع', en: 'Quick guide' },
  perfectMatch: { ar: 'مطابقة تامّة: العنصر والرقم معاً', en: 'Perfect match: same element and number' },
  guideTap: { ar: 'انقر كارتاً للعبه', en: 'Tap a card to play it' },
  guideHold: { ar: 'اضغط مطوّلاً للتفاصيل', en: 'Hold for details' },
  guideTarget: { ar: 'حدّد وحشك ثم انقر الهدف', en: 'Select your monster, then tap a target' },
  cardsWord: { ar: 'كرت في يدك', en: 'cards in hand' },
